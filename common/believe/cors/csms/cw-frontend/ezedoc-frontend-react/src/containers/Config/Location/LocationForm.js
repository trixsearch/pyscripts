...
class LocationForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            validationSchema: {
                ...
                .matches(SPECIAL_CHARACTERS_ERROR_REGEX, { message: getRegexErrorMessage('location name'), excludeEmptyString: true }),
                head: Yup.string().required('Select Location Head').nullable()
            },
            components: [],
            lists: {},
            extra_fields: {},
    ...
    componentDidMount() {
        ...
        Axios.get(`${APP_URL}/${this.props.orgId}/config/custom_attribute/get_attribute?type=locations`)
        .then(res => {
        ...
        if (edit && id) {
            ...
            Axios.get(`${APP_URL}/${this.props.orgId}/locations/${this.props.id}`).then(response => {
                this.setState({
        ...
        return (
            <Formik
                ...
                onSubmit={(values) => {
                    ...
                    this.handleSubmit(name.replace(/^\s+|\s+$/g, ''), head.value, reduceCustomAttribs(extra_fields))
                }}
                            ...
                            <div className="edit_app_detils_form_cont config-section-form">
                                <div className="form_up_box row">
                                    ...
                                    <div className="floating-label col-md-6 displayBlock">
                                        ...
                                        />
                                        <label className="react-select-label">Location Head</label>
