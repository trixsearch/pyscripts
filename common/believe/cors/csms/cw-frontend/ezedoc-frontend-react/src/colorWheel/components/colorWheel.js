...
class ColourWheel extends Component {
  ...
  componentDidMount () {
    ...
    this.canvasEl = document.getElementById('colour-picker' + this.props.canvasId)
  ...
  render () {
    ...
    let canvasId = 'colour-picker'+ this.props.canvasId; 
    return (
      dynamicCursor ? (
        <canvas
          id={canvasId}
